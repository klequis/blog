...
date: '2019-11-28'
tags: ['mongodb', 'installing-software', 'ubuntu']
draft: false
summary: MongoDB is the 'M' in MERN.
---
...
<br />
<br />
![authentication not enabled message](/static/images/authentication-not-enabled-message.png )
...
Exit the Mongo Shell by pressing <tag>'ctrl+c'</tag>
