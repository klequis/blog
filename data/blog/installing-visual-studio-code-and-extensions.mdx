...
date: '2019-11-15'
tags: ['visual-studio-code', 'vscode', 'installing-software', 'ubuntu']
draft: false
summary: With the addition of a few extensions VS Code is a great code editor.
---

![installing visual studio code and extensions banner](static/images/installing-visual-studio-code-and-estensions/installing-visual-studio-code-and-extensions.banner.png)
...
![launch Ubuntu software](static/images/installing-visual-studio-code-and-estensions/launch-ubuntu-software.png)
...
![update imports on file move set to never](static/images/installing-visual-studio-code-and-estensions/update-imports-on-file-move.never.png)
...
![window title set](static/images/installing-visual-studio-code-and-estensions/window-title-set.png)
...
![tab size set to 2](static/images/installing-visual-studio-code-and-estensions/tab-size.png)
