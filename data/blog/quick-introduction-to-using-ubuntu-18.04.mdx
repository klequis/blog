...
![ubuntu activities overview](static/images/quick-introduction-to-using-ubuntu-18.04activities-overview.png)
...
![search for fire](static/images/quick-introduction-to-using-ubuntu-18.04search-bar-fire.png)
...
![visual studio code in ubuntu software](static/images/quick-introduction-to-using-ubuntu-18.04ubuntu-software-vscode.png)
...
![the dash](static/images/quick-introduction-to-using-ubuntu-18.04dash.png)
...
![activities](static/images/quick-introduction-to-using-ubuntu-18.04activities.png)
...
![application menu for terminal](static/images/quick-introduction-to-using-ubuntu-18.04application-menu-terminal.png)

**Application menu for Atom**

![application menu for atom](static/images/quick-introduction-to-using-ubuntu-18.04application-menu-atom.png)
...
![notifications and calendar](static/images/quick-introduction-to-using-ubuntu-18.04notifications-calendar.png)
...
![system menu](static/images/quick-introduction-to-using-ubuntu-18.04system-menu.png)
...
![alt-tab](static/images/quick-introduction-to-using-ubuntu-18.04alt-tab.png)
...
![settings > Dock](static/images/quick-introduction-to-using-ubuntu-18.04settings.png)
...
![gnome tweaks](static/images/quick-introduction-to-using-ubuntu-18.04tweaks.png)
