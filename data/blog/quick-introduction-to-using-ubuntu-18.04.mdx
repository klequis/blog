...
draft: false
summary: If you are brand-new to Ubuntu, here is a quick overview to get you started.
---
...
![ubuntu activities overview](/static/images/quick-introduction-to-using-ubuntu-18.04/activities-overview.png)
...
![search for fire](/static/images/quick-introduction-to-using-ubuntu-18.04/search-bar-fire.png)
...
![visual studio code in ubuntu software](/static/images/quick-introduction-to-using-ubuntu-18.04/ubuntu-software-vscode.png)
...
![the dash](/static/images/quick-introduction-to-using-ubuntu-18.04/dash.png)
...
![activities](/static/images/quick-introduction-to-using-ubuntu-18.04/activities.png)
...
![application menu for terminal](/static/images/quick-introduction-to-using-ubuntu-18.04/application-menu-terminal.png)

**Application menu for Atom**

![application menu for atom](/static/images/quick-introduction-to-using-ubuntu-18.04/application-menu-atom.png)
...
![notifications and calendar](/static/images/quick-introduction-to-using-ubuntu-18.04/notifications-calendar.png)
...
![system menu](/static/images/quick-introduction-to-using-ubuntu-18.04/system-menu.png)
...
![alt-tab](/static/images/quick-introduction-to-using-ubuntu-18.04/alt-tab.png)
...
![settings > Dock](/static/images/quick-introduction-to-using-ubuntu-18.04/settings.png)
...
![gnome tweaks](/static/images/quick-introduction-to-using-ubuntu-18.04/tweaks.png)
