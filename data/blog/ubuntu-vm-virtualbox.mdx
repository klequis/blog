...
date: '2019-09-27'
tags: ['ubuntu', 'virtual-machine', 'virtual-box']
draft: false
summary: There are many reasons to try Linux. Installing it in a virtual machine is a risk free and $$ free way to get started.
---

![banner](/static/images/ubuntu-vm-virtualbox/hero-blog.png)
...
![set host key to none](/static/images/ubuntu-vm-virtualbox/set-host-key-to-none.png)
...
![VirtualBox Initial Launch](/static/images/ubuntu-vm-virtualbox/virtualbox-initial-launch.png)

{/* <Image src="/static/images/ubuntu-vm-virtualbox/virtualbox-initial-launch.png" alt="Picture of the author" width={500} height={500} /> */}
...
![Name and operating system](/static/images/ubuntu-vm-virtualbox/name-and-operating-system.png)
...
![Memory size](/static/images/ubuntu-vm-virtualbox/memory-size.png)
...
![Hard disk](/static/images/ubuntu-vm-virtualbox/hard-disk.png)
...
![Hard disk file type](/static/images/ubuntu-vm-virtualbox/hard-disk-file-type.png)
...
- Click Next
  ...
  ![Storage on physical hard disk](/static/images/ubuntu-vm-virtualbox/storage-on-physical-hard-disk.png)
...
![File location and size](/static/images/ubuntu-vm-virtualbox/file-location-and-size.png)
...
![click settings](/static/images/ubuntu-vm-virtualbox/click-settings.png)
...
![general advanced](/static/images/ubuntu-vm-virtualbox/general-advanced.png)
...
![system processor](/static/images/ubuntu-vm-virtualbox/system-processor.png)
...
![display screen](/static/images/ubuntu-vm-virtualbox/display-screen.png)

## Installing the OS

- In the left pane, double click the the VM you just created or right-click it and click Start

![VM in left hand pane](/static/images/ubuntu-vm-virtualbox/vm-created.png)
...
![Select a start-up disk](/static/images/ubuntu-vm-virtualbox/select-start-up-disk.png)
...
![welcome screen](/static/images/ubuntu-vm-virtualbox/welcome.png)

### Keyboard layout

- Select your desired keyboard layout and click Continue

![keyboard layout](/static/images/ubuntu-vm-virtualbox/keyboard-layout.png)
...
![updates and other software](/static/images/ubuntu-vm-virtualbox/updates-and-other-software.png)
...
![installation type](/static/images/ubuntu-vm-virtualbox/installation-type.png)

### Write the changes to disks?

- Click Continue

![Write the changes to disk](/static/images/ubuntu-vm-virtualbox/write-the-changes-to-disk.png)
...
![where are you](/static/images/ubuntu-vm-virtualbox/where-are-you.png)
...
![Who are you](/static/images/ubuntu-vm-virtualbox/who-are-you.png)
...
![welcome to ubuntu](/static/images/ubuntu-vm-virtualbox/welcome-to-ubuntu.png)

Time for a break
![coffee break](/static/images/ubuntu-vm-virtualbox/coffee.gif)
...
![installation complete](/static/images/ubuntu-vm-virtualbox/installation-copmplete.png)
...
![press-enter](/static/images/ubuntu-vm-virtualbox/press-enter.png)
...
![software-updater](/static/images/ubuntu-vm-virtualbox/software-updater.png)
...
![all done](/static/images/ubuntu-vm-virtualbox/all-done.png)
...
![insert guest additions cd image](/static/images/ubuntu-vm-virtualbox/insert-guest-additions-cd-image.png)

Click Run

![do you want to run guest additions](/static/images/ubuntu-vm-virtualbox/do-you-want-to-run-ga.png)

You will be asked to enter the current user's password.

![authentication required](/static/images/ubuntu-vm-virtualbox/authentication-required.png)
...
![add shared folder](/static/images/ubuntu-vm-virtualbox/add-shared-folder.png)
...
![add share](/static/images/ubuntu-vm-virtualbox/add-share.png)
