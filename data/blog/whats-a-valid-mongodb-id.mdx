...
date: '2019-11-09'
tags: ['mongodb', 'objectid', 'features']
draft: false
summary: I'm not the only one who made an incorrect assumption about MongoDB's `ObjectID.isValid()` function.
---
...
![document in Robo 3T](static/images/whats-a-valid-mongodb-id/objIdInRobo3T.png)
